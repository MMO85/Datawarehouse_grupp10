...
GRANT USAGE ON SCHEMA HR_JOBS.STAGING TO ROLE ROLE_PROJECT_ADMIN;
GRANT USAGE ON SCHEMA HR_JOBS.DWH TO ROLE ROLE_PROJECT_ADMIN;
GRANT USAGE ON SCHEMA HR_JOBS.MART TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON ALL TABLES IN SCHEMA HR_JOBS.STAGING TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON ALL TABLES IN SCHEMA HR_JOBS.DWH TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON ALL TABLES IN SCHEMA HR_JOBS.MART TO ROLE ROLE_PROJECT_ADMIN;
GRANT USAGE ON FUTURE SCHEMAS IN DATABASE HR_JOBS TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON FUTURE TABLES IN SCHEMA HR_JOBS.STAGING TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON FUTURE TABLES IN SCHEMA HR_JOBS.DWH TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON FUTURE TABLES IN SCHEMA HR_JOBS.MART TO ROLE ROLE_PROJECT_ADMIN;

GRANT SELECT ON ALL VIEWS IN SCHEMA HR_JOBS.STAGING TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON ALL VIEWS IN SCHEMA HR_JOBS.DWH TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON ALL VIEWS IN SCHEMA HR_JOBS.MART TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA HR_JOBS.STAGING TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA HR_JOBS.DWH TO ROLE ROLE_PROJECT_ADMIN;
GRANT SELECT ON FUTURE VIEWS IN SCHEMA HR_JOBS.MART TO ROLE ROLE_PROJECT_ADMIN;
